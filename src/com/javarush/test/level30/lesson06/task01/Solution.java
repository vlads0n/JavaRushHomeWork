    ...
    public static void checkAFlag(D d) {
        if(d != null){
            if (d.cs != null)
                if (d.cs.size() != 0)
                    if (d.cs.get(0) != null)
                        if (d.cs.get(0).bs != null)
                          if (d.cs.get(0).bs.size() != 0)
                            if (d.cs.get(0).bs.get(0) != null)
                             if (d.cs.get(0).bs.get(0).as != null)
                                 if (d.cs.get(0).bs.get(0).as.size() != 0)
                                    if (d.cs.get(0).bs.get(0).as.get(0) != null)
