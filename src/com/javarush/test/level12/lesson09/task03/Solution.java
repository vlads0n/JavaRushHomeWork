...
public class Solution
{
    ...
    abstract class Dog implements Run, Swim
    {
    }

    abstract class Fish implements Swim
    {
    }

    abstract class Bird implements Fly, Run, Swim
    {
    }

    abstract class Airplane implements Fly, Run
    {
    }
}
