...
public class Solution {
    ...
    public static Object convertOneToAnother(Object one, Class resultClassObject) throws IOException {
        ...
        String first = one.getClass().getSimpleName().toLowerCase();
        String second = resultClassObject.getSimpleName().toLowerCase();

        String resultString = jsonString.replaceFirst(first, second);
