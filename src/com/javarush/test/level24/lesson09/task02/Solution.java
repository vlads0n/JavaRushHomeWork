...
public class Solution {
    ...
    public static void sort(List<Stock> list) {
        Collections.sort(list, new Comparator<Stock>()
        {
            ...
            {
                int nameDif = ((String) stock1.get("name")).compareTo((String) stock2.get("name"));

                int dateDif = ((Date) stock1.get("date")).compareTo((Date) stock2.get("date"));
                ...
                if (stock1.containsKey("open"))
                    ...
                    d1 = (double) stock1.get("change");

                if (stock2.containsKey("open"))
                    d2 = (double) stock2.get("last") - (double) stock2.get("open");
                else
                    d2 = (double) stock2.get("change");

                int changeDif = Double.compare(d1, d2);
