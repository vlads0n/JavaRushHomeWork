...
public class Solution {
    ...
    public static void printMatrix(Integer m, int n, Character value) {}
    public static void printMatrix(int m, Integer n, Character value) {}
    public static void printMatrix(Integer m, Integer n, Character value) {}
