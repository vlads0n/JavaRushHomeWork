...
public class Solution {
    ...
    public static class AmigoThreadFactory implements ThreadFactory {
        ...
        private AtomicInteger threadAtomic = new AtomicInteger(0);
        ...
        public AmigoThreadFactory()
        {
            ...
            currentPoolNumber = pool.incrementAndGet();
        }
        ...
        public Thread newThread(Runnable r)
        {
            ...
            thread.setName(threadGroup.getName() + "-pool-" + currentPoolNumber + "-thread-" + threadAtomic);
            return thread;
        }
    }
